...
export const Start = ({ navigation }) => {
    ...
    return (
        <View style={styles.container} >
            ...
            <Image source={require('../assets/test_logo.png')} style={{ width: 100, height: 100, borderRadius: 50 }} />
            <View style={{ display: 'flex', flexDirection: 'row', width: '100%', justifyContent: 'space-between' }}>
                <Button title='Login' style={{ margin: '50px' }} onPress={() => navigation.navigate('Login')}></Button>
